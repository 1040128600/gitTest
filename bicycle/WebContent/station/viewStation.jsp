...
<div class="container">
<div class="public-nav">您当前的位置：<a href="station/stationManager.jsp">车点管理</a>><label>查看车点</label></div>
<div class="public-content" >
	...
	<div class="form-group">
		<label for="">名称</label>
		<input   class="form-input-txt"  type="text" name="station_Name"  value="${station0.station_Name}" readonly>
	</div>
	<div class="form-group">
		<label for="">经度</label>
		<input   class="form-input-txt"  type="text" name="longitude"  value="${station0.longitude}" readonly>
	</div>
		<div class="form-group">
		<label for="">纬度</label>
		<input   class="form-input-txt"  type="text" name="latitude"  value="${station0.latitude}" readonly>
	</div>
		<div class="form-group">
		...
		<div class="form-group">
		<label for="">地址</label>
		<input   class="form-input-txt"  type="text" name="address"  value="${station0.address}" readonly>
	</div>
		<div class="form-group">
		<label for="">负责人</label>
		<input   class="form-input-txt"  type="text" name="person_In_Charge"  value="${station0.person_In_Charge}" readonly>
	</div>
		<div class="form-group">
		<label for="">新建日期</label>
		<input   class="form-input-txt"  type="date" name="build_Time"  value="${station0.build_Time}" readonly>
	</div>
		<div class="form-group">
		<label for="">运行日期</label>
		<input   class="form-input-txt"  type="date" name="run_Time"  value="${station0.run_Time}" readonly>
	</div>
		<div class="form-group">
		<label for="">操作人ID</label>
		<input   class="form-input-txt"  type="text" name="user_Id"  value="${station0.user_Id}" readonly>
	</div>
		<div class="form-group">
		<label for="">创建时间</label>
		<input   class="form-input-txt"  type="date" name="create_Time"  value="${station0.create_Time}" readonly>
	</div>
	...
	<label for="">注销标记</label>
		...
		<div class="form-group">
	<label for="">备注</label>
	<input   class="form-input-txt"  type="text" name="remark" placeholder="" value="${station0.remark}" readonly>
	</div>
	<br><br>
	...
	<h5>车桩列表</h5>
			...
			<td >
			<select name="piles[${status.index}].status">
...
<%-- 			<input class='my-small-input' name='piles[${status.index}].status' type='text' value='${pile.status}'/>
 --%>			
			</td>

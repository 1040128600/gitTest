...
<base href="<%=basePath %>"/>
	...
	<script type="text/javascript" src="vender//addVender.js"></script>
	<style type="text/css">
...
<input id="authority" type="hidden" value="${user0.u_authority}" />
<div class="container">
<div class="public-nav">您当前的位置：<a href="venderManager.jsp">供应商管理</a>><label>新增</label></div>
...
<%-- 	<input   class="form-input-txt"  type="text" name="vender_Type" placeholder="" value="${vender.vender_Type}">
 --%>	</div>
	...
	<input  class="form-input-txt"  type="text" name="user_Id" placeholder="" value="${loginUser.user_Id}" readonly>
	</div>
		<div class="form-group">
